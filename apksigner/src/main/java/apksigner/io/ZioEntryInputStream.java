...
public class ZioEntryInputStream extends InputStream {
    ...
    public ZioEntryInputStream(@NotNull ZioEntry entry) throws IOException {
        offset = 0;
    ...
    // For debugging, if the monitor is set we write all data read to the
    // monitor.
