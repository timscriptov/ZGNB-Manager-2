...
public class ZioEntry implements Cloneable {
    ...
    public static @Nullable ZioEntry read(@NotNull ZipInput input) throws IOException {
    ...
    public void writeLocalEntry(ZipOutput output) throws IOException {
        ...
        numAlignBytes = 0;
        // Zipalign if the file is uncompressed, i.e., "Stored", and file size
        // is not zero.
    ...
    private void doRead(@NotNull ZipInput input) throws IOException {
        ...
        // Bits 1, 2, 3, and 11 are allowed to be set (first bit is bit zero).
        // Any others are a problem.
    ...
    public InputStream getInputStream(OutputStream monitorStream)
        ...
        if (compression != 0) {
            // Note: When using nowrap=true with Inflater it is also necessary
            // to provide
            // an extra "dummy" byte as input. This is required by the ZLIB
            // native library
    ...
    public void write(@NotNull ZipOutput output) throws IOException {
