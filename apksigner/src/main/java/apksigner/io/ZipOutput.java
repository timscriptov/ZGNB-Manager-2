...
public class ZipOutput {
    ...
    public ZipOutput(@NotNull File outputFile) throws IOException {
    ...
    private void init(@NotNull File ofile) throws IOException {
        if (ofile.exists())
            ofile.delete();
        out = new FileOutputStream(ofile);
    }

    public void write(@NotNull ZioEntry entry) throws IOException {
    ...
    public void close() throws IOException {
        ...
        centralEnd.numCentralEntries = centralEnd.totalCentralEntries = (short) entriesWritten
                .size();
