 ...
 */
package com.bigzhao.xml2axml.android.content.res;
...
public class StringBlock {
     ...
     */
    public static @NotNull StringBlock read(IntReader reader) throws IOException {
    ...
    @Contract(pure = true)
    private static final int getShort(int @NotNull [] array, int offset) {
