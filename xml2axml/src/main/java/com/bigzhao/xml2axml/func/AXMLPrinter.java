...
public class AXMLPrinter {
    ...
    public static void main(String @NotNull [] arguments) {
    ...
    private static @NotNull String getNamespacePrefix(String prefix) {
    ...
    private static String getAttributeValue(@NotNull AXmlResourceParser parser, int index) {
    ...
    @Contract(pure = true)
    private static @NotNull String getPackage(int id) {
        if (id >>> 24 == 1) {
            return "android:";
        }
        return "";
