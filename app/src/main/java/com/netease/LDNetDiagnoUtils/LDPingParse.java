...
public class LDPingParse {
    public static @NotNull String getFormattingStr(String host, @NotNull String log) {
    ...
    private static @NotNull List<String> getTime(String log) {
    ...
    private static @NotNull List<String> getSumBytes(String log) {
    ...
    private static @NotNull List<String> getTTL(String log) {
    ...
    private static @NotNull List<String> getIcmp_seq(String log) {
