...
public class TileDrawable extends Drawable {
    ...
    private Handler mRequestCurrentTilesDelayHandler = new Handler(msg -> {
    ...
    private static int @NotNull [] cutFragments(int totalLength, int fragmentRequestLength) {
    ...
    private void initTiles(Point container) {
        if (mTiles == null) {
            ...
            PinchImageView.MathUtils.calculateScaledRectInContainer(new RectF(0, 0, sWidth, sHeight), iWidth, iHeight, AppCompatImageView.ScaleType.FIT_CENTER, scaledRect);
