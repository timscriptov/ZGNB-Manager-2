...
public class StringIdsEditor implements Edit {
    ...
    private static void filterString(ClassDataItem.@NotNull EncodedMethod method,
                                     HashMap<StringIdItem, StringIdItem> stringIdsMap) {
                    ...
                    case Format31c:
                        switch (instruction.opcode.referenceType) {
                            case string:
                                ...
                                stringIdsMap.put(
                                        (StringIdItem) ref.getReferencedItem(), null);
                        }
                }
            }
        }
    ...
    public void read(List<String> data, byte[] input) throws IOException {
        ...
        List<ClassDefItem> classes = ClassListActivity.dexFile.ClassDefsSection
                .getItems();
        ...
        //
        ArrayList<StringIdItem> stringIds = new ArrayList<>();
