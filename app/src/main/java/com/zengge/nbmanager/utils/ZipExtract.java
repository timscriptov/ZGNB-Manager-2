...
public class ZipExtract {
    ...
    public static void unzipAll(@NotNull ZipFile zipFile, File outPath) throws Exception {
    ...
    public static void extractEntry(ZipFile zipFile, @NotNull ZipEntry entry,
    ...
    public static void extractEntryForByteArray(byte[] input, String entryName,
                                                File outPath) throws Exception {
