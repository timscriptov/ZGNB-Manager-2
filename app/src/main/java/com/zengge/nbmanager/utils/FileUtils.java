...
public class FileUtils {
    ...
    public static int chmod(@NotNull File path, int mode) throws Exception {
    ...
    public static int getPermissions(@NotNull File path) throws Exception {
        int[] result = new int[1];
        FileHelper.getPermissions(path.getAbsolutePath(), result);
        return result[0];
    }

    public static @NotNull FileStatus getFileStatus(@NotNull File path) throws Exception {
        FileStatus result = new FileStatus();
        Class<?> fileUtils = Class.forName("android.os.FileUtils");
        @SuppressLint("PrivateApi") Class<?> fileStatus = Class.forName("android.os.FileUtils$FileStatus");
        Method getOsFileStatus = fileUtils.getMethod("getFileStatus",
                String.class, fileStatus);
    ...
    public static @Nullable File copyFromStream(String name, InputStream input) {
    ...
    public static boolean rename(@NotNull File file, String name) {
    ...
    public static @NotNull String readFromAssetsFile(@NotNull Context context, String name)
            throws IOException {
