...
public final class FileUtil {
     ...
     * @param length the number of bytes to read, or -1 to read to the end of the
     *               file
     * @return non-null; contents of the file
     */
    public static byte[] readFile(@NotNull File file, int offset, int length)
            throws IOException {
        if (!file.exists())
    ...
    public static byte @NotNull [] readStream(InputStream in, int length)
            throws IOException {
