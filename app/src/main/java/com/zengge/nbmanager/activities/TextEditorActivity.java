...
import com.zengge.nbmanager.StringIdsEditor;
import com.zengge.nbmanager.TextSettings;
import com.zengge.nbmanager.TypeIdsEditor;
import com.zengge.nbmanager.res.ARSCEditor;
import com.zengge.nbmanager.res.AXmlEditor;
import com.zengge.nbmanager.utils.StringUtils;
...
public class TextEditorActivity extends AppCompatActivity {
    ...
    private void searchString() {
        ...
        final AppCompatCheckBox from_start = scroll
                .findViewById(R.id.from_start);
        final AppCompatEditText srcName = scroll.findViewById(R.id.src_edit);
        final AppCompatCheckBox isReplace = scroll.findViewById(R.id.replace);
        final AppCompatEditText dstName = scroll
    ...
    private void write() {
        ...
        try {
            ...
            TextEditorActivity.data = baos.toByteArray();
    ...
    public boolean onOptionsItemSelected(@NotNull MenuItem mi) {
        switch (mi.getItemId()) {
            ...
            case R.id.preferences: {
                startActivityForResult(new Intent(this, TextSettingsActivity.class), 0);
                break;
            }
        }
        return true;
    ...
    static class Text implements Edit {
        ...
        public void write(@NotNull String data, @NotNull OutputStream out) throws IOException {
