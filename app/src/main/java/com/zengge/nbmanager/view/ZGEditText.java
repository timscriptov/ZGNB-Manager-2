package com.zengge.nbmanager.view;
...
public class ZGEditText extends AppCompatEditText {
    public static final String TAG = "ZGEditText";
    ...
    public ZGEditText(Context context, AttributeSet attr) {
        super(context, attr);
    }

    public ZGEditText(Context context, AttributeSet attr, int a) {
    ...
    public InputConnection onCreateInputConnection(EditorInfo edit) {
        ...
        return new InputConnection() {
            ...
            public boolean setComposingText(CharSequence text,
                ...
                Log.w(TAG, "setComposingText(\"" + text + "\", "
                        + newCursorPosition + ")");
        ...
        switch (id) {
            ...
            case ID_PASTE:
                ...
                if (paste != null) {
                    ...
                    ((Editable) text).replace(min, max,
                            Utf8Utils.escapeString(paste.toString()));
                }
                return true;
            case ID_COPY_URL:
