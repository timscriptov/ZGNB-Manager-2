...
public class Parser {
    ...
    private static StringIdItem parseString(DexFile dexFile, @NotNull String s) {
        ...
        return StringIdItem.internStringIdItem(dexFile,
                escapeSequence(s.substring(i + 1, j)));
    }
    ...
    public static @NotNull String escapeSequence(@NotNull String string) {
            ...
            if (c == '\\') {
                ...
                switch (nextChar) {
                    ...
                    case 'u':
                        i++;
                        if (i > len - 4)
                            throw new IllegalArgumentException("unicode error: "
                    ...
                    default:
                        throw new IllegalArgumentException(
                                "escape Sequence error: " + string.substring(i - 1));
                }
            } else
                sb.append(c);
        }
    ...
    private static int digit(char c) {
        ...
        if (result < 0 || result > 15) {
            throw new IllegalArgumentException("illegal not hex character: "
                    + c);
        }
        return result;
    }
    ...
    public void dump(IndentingWriter writer) throws IOException {
        ...
        /*
         * for(int tes: tryLabels){ System.out.println(""+tes); }
         */
        // dump instruction
            ...
            switch (instruction.getFormat()) {
                ...
                case Format51l:
                    ...
                    writer.printIntAsDec(((SingleRegisterInstruction) instruction)
                            .getRegisterA());
                    writer.write(' ');
                    writer.write(String.valueOf(((LiteralInstruction) instruction)
                            .getLiteral()));
                    writer.write('\n');
                    break;
                case Format22x:
