...
public class ClassEditor {
    ...
    public ClassEditor(@NotNull ClassDefItem classDef) {
    ...
    public ClassDefItem copyClassDefItem(DexFile dexFile) {
        TypeIdItem classType = CodeEditor.internTypeIdItem(dexFile,
                this.classType);
        TypeIdItem superClass = CodeEditor.internTypeIdItem(dexFile,
                this.superClass);
        TypeListItem interfaces = CodeEditor.copyTypeListItem(dexFile,
                this.interfaces);
        List<ClassDataItem.EncodedField> staticFields = copyField(dexFile,
                staticFieldEditors);
        List<ClassDataItem.EncodedField> instanceFields = copyField(dexFile,
                instanceFieldEditors);
        List<ClassDataItem.EncodedMethod> directMethods = copyMethod(dexFile,
                directMethodEditors);
        List<ClassDataItem.EncodedMethod> virtualMethods = copyMethod(dexFile,
                virtualMethodEditors);
        ...
        return ClassDefItem.internClassDefItem(dexFile, classType, accessFlags,
                superClass, interfaces, null, null, classData, null);
    }

    public List<ClassDataItem.EncodedField> copyField(DexFile dexFile,
                                                      FieldEditor[] editors) {
        List<ClassDataItem.EncodedField> out = new ArrayList<ClassDataItem.EncodedField>(
                editors.length);
    ...
    public List<ClassDataItem.EncodedMethod> copyMethod(DexFile dexFile,
                                                        MethodEditor[] editors) {
        List<ClassDataItem.EncodedMethod> out = new ArrayList<ClassDataItem.EncodedMethod>(
                editors.length);
