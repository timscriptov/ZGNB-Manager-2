...
namespace android {
    ...
    extern "C" JNIEXPORT jobject JNICALL Java_android_os_FileHelper_getpwuid(JNIEnv *env, jobject clazz, jint uid) {
    ...
    extern "C" JNIEXPORT jobject JNICALL Java_android_os_FileHelper_getgrgid(JNIEnv *env, jobject clazz, jint gid) {
        //获取Java中的实例类
        //li("----------getgrgid");
    ...
    extern "C" JNIEXPORT jint JNICALL Java_android_os_FileHelper_chown(JNIEnv *env, jobject clazz, jstring file, jint uid, jint gid) {
        int res;
        char *str = j2c(env, file);
        if (strlen(str) <= 0 || !str) {
            return ENOENT;
    ...
    extern "C" JNIEXPORT jint JNICALL Java_android_os_FileHelper_chmod(JNIEnv *env, jobject clazz, jstring file, jint mode) {
        char *str = j2c(env, file);
        if (strlen(str) <= 0 || !str) {
            return ENOENT;
        }
...
#define VFAT_IOCTL_GET_VOLUME_ID _IOR('r', 0x12, __u32)
    ...
    extern "C" JNIEXPORT jint JNICALL Java_android_os_FileHelper_getFatVolumeId(JNIEnv *env, jobject clazz, jstring path) {
        if (path == NULL) {
            exit(0);
            return -1;
        }
