...
extern "C" JNIEXPORT jboolean JNICALL Java_com_zengge_nbmanager_Features_ZipAlign(JNIEnv *env, jclass cls, jstring str1, jstring str2) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_com_zengge_nbmanager_Features_isZipAligned(JNIEnv *env, jclass cls, jstring str) {
