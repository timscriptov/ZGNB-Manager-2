...
public class ClassReference14Processor {
  ...
  private static void processClassRec(@NotNull ClassNode node, Map<ClassWrapper, MethodWrapper> mapClassMeths, Set<? super ClassWrapper> setFound) {
  ...
  private static void mapClassMethods(@NotNull ClassNode node, Map<ClassWrapper, MethodWrapper> map) {
  ...
  private static boolean replaceInvocations(@NotNull Exprent exprent, ClassWrapper wrapper, MethodWrapper meth) {
    boolean res = false;
  ...
  private static @Nullable String isClass14Invocation(@NotNull Exprent exprent, ClassWrapper wrapper, MethodWrapper meth) {
