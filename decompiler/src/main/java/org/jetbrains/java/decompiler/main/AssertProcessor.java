...
public class AssertProcessor {
  ...
  private static @Nullable StructField findAssertionField(@NotNull ClassNode node) {
  ...
  private static boolean replaceAssertions(@NotNull Statement statement, String classname, String key) {
  ...
  private static boolean replaceAssertion(Statement parent, @NotNull IfStatement stat, String classname, String key) {
  ...
  private static Object @NotNull [] getAssertionExprent(@NotNull Exprent exprent, String classname, String key, boolean throwInIf) {
