...
public class ClassesProcessor implements CodeConstants {
  ...
  private static class Inner {
    ...
    @Contract(pure = true)
    private static boolean equal(@NotNull Inner o1, @NotNull Inner o2) {
  ...
  private static boolean isAnonymous(@NotNull StructClass cl, StructClass enclosingCl) {
  ...
  public void writeClass(@NotNull StructClass cl, TextBuffer buffer) throws IOException {
  ...
  private static void initWrappers(@NotNull ClassNode node) {
  ...
  private static void addClassnameToImport(@NotNull ClassNode node, ImportCollector imp) {
  ...
  private static void destroyWrappers(@NotNull ClassNode node) {
    node.wrapper = null;
  ...
  public static class ClassNode {
    ...
    public ClassNode(String content_class_name,
                     ...
                     @NotNull StructClass classStruct) { // lambda class constructor
    ...
    public ClassNode(int type, @NotNull StructClass classStruct) {
      this.type = type;
