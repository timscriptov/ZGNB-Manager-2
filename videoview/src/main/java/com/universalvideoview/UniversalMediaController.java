...
//    private boolean mFullscreenEnabled = false;
    ...
    private AppCompatTextView mEndTime, mCurrentTime;
    ...
    private AppCompatImageButton mTurnButton;// 开启暂停按钮
    private AppCompatImageButton mScaleButton;
    ...
    private void initControllerView(View v) {
        ...
        mTurnButton = (AppCompatImageButton) v.findViewById(R.id.turn_button);
        mScaleButton = (AppCompatImageButton) v.findViewById(R.id.scale_button);
        ...
        mEndTime = (AppCompatTextView) v.findViewById(R.id.duration);
        mCurrentTime = (AppCompatTextView) v.findViewById(R.id.has_played);
