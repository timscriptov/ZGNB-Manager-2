...
public class JSources extends JNode {
     ...
     */
    public List<JPackage> getHierarchyPackages(@NotNull List<JavaPackage> packages) {
    ...
    private void addPackage(@NotNull Map<String, JPackage> pkgs, @NotNull JPackage pkg) {
